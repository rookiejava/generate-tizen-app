            ...
            Add(new HStack
            {
                ...
                new Button("Visual")
                {
                    Clicked = async () =>
                    {
                        ...
                        for (int i = 0; i < 5000; i++)
                        {
                            flex.Add(new VisualComponent().Margin(10));
                        }
                        Console.WriteLine($"Elapsed : {stopwatch.ElapsedMilliseconds}");
                        UIApplication.Current.PostToUI(() =>
                        {
        ...
        class VisualComponent : View
        {
            ...
            public VisualComponent()
            {
                ...
                this.Add(new ColorVisual
                {
                    ...
                    Color = Color.Red,
                    X = 0.1f,
                    PivotPoint = VisualAlign.CenterBegin,
                    Origin = VisualAlign.CenterBegin
                });
                ...
                this.Add(new ColorVisual
                {
                    ...
                    Color = Color.Blue,
                    X = -0.1f,
                    PivotPoint = VisualAlign.CenterEnd,
                    Origin = VisualAlign.CenterEnd
                });
