...
{
    public class RendererTest2 : Grid, ITestCase
    {
        Renderer _customRenderer;
        public RendererTest2()
        {
            ...
            PixelBuffer pixelbuffer = ImageLoader.LoadImageFromFile("mask2.png");
            PixelData pixels = PixelBuffer.Convert(pixelbuffer);
            Texture texture = new Texture(TextureType.TEXTURE_2D, pixels.PixelFormat, pixels.Width, pixels.Height);
            texture.Upload(pixels, 0, 0, 0, 0, pixels.Width, pixels.Height);
            TextureSet textureset = new TextureSet();
            textureset.SetTexture(0, texture);

            _customRenderer.SetTextures(textureset);
        ...
        Geometry CreateQuadGeometry()
        {
            ...
            vertices[0] = new Vertex(); vertices[0].pos = new Vec2(-0.5f, -0.5f);
            vertices[1] = new Vertex(); vertices[1].pos = new Vec2(-0.5f, 0.5f);
            vertices[2] = new Vertex(); vertices[2].pos = new Vec2(0.5f, -0.5f);
            vertices[3] = new Vertex(); vertices[3].pos = new Vec2(0.5f, 0.5f);
