...
namespace TizenUIGallery
{
    partial class App : UIApplication
    {
        ...
        public App() : base(WindowMode.Transparent)
        {
        ...
        protected override void OnCreate()
        {
            ...
            Console.WriteLine($"ScreenSize : {DisplayMetrics.ScreenWidth}x{DisplayMetrics.ScreenHeight}");

            Console.WriteLine("OnCreate");
            //MemoryProfile_EmptyScene();
            //MemoryProfile_SimpleScene1();
            //MemoryProfile_DynamicScene();
            //MemoryProfile_DynamicScene2();
            //MemoryProfile_DynamicScene3();
            //MemoryProfile_DynamicScene4();
            //MemoryProfile_CreateDeleteScene();
            //StartTimeProfile_SimpleScene();

            _mainList = new TestList(GetTestCase());
            Window.Default.DefaultLayer.Name = "DefaultLayer";
            ...
            //DisplayMetrics.SetScaleFactors(1, Window.Default.DPI / 160f);
            DisplayMetrics.SetDensityBasedScaleFactor();

            ResourceLocalizer.LoadResourceManager("TizenUIGallery.Resource.Strings", typeof(App).Assembly);
        ...
        void Default_KeyEvent(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyEvent.State == KeyState.Up && (e.KeyEvent.KeyPressedName == "XF86Back" || e.KeyEvent.KeyPressedName == "Escape"))
            {
