...
In new touch system, the gesture should be handled by touch event like android,
...
To support legacy way that uses `Attach` method of gesture detector, Tizen.UI also provide this way.
